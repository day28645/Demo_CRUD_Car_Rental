<%@ Page Title="" Language="C#" MasterPageFile="~/Employee.Master" AutoEventWireup="true" CodeBehind="EditCar.aspx.cs" Inherits="Demo_CRUD_Car_Rental.Page_Employee.EditCar" %>
        ...
        <div class="row justify-content-md-center">
            <div class="col-6">
                <div class="bg-light p-4 p-md-5 rounded shadow-sm">
                    <h3 class="mb-5">Edit Car Information</h3>
                    ...
                    <div class="container">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <asp:TextBox runat="server" type="text" CssClass="form-control-sm" ID="txt_regisno" />
                            </div>
                        </div>
                        <br />
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <asp:TextBox runat="server" type="number" min="0" max="10000" step="1000" CssClass="form-control-sm" ID="num_car_rent" />
                            </div>
                        </div>
                        <br />
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <asp:TextBox runat="server" type="text" CssClass="form-control-sm" ID="txt_owner" />
                            </div>
                        </div>
                        <br />
                    ...
                    <div class="container">
                        <div class="text-center">
                            <asp:Button ID="edit_car" runat="server" 
                                CssClass="btn btn-warning btn-lg"
                                Text="Edit Car" 
                                OnClick="edit_car_Click" />
                        </div>
                    </div>
